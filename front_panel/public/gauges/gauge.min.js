(function () {
    ...
    !(function () {
        ...
        (p = function () {
            ...
            return (
                (e = (i =
                    1 <= arguments.length ? g.call(arguments, 0) : [])[0]),
                (t = i[1]),
                l(e.toFixed(t))
            );
        }),
        ...
        (s = (function (t) {
            ...
            return (
                ...
                (i.prototype.parseValue = function (t) {
                    return (
                        (t = parseFloat(t) || Number(t)), isFinite(t) ? t : 0
                    );
                }),
                i
            );
            ...
            return (
                ...
                (i.prototype.render = function () {
                    ...
                    if (
                        ...
                        (o = Math.round(
                            this.strokeWidth * Math.cos(t - Math.PI / 2)
                        )),
                        (a = Math.round(
                            this.strokeWidth * Math.sin(t - Math.PI / 2)
                        )),
                        (i = Math.round(
                            this.strokeWidth * Math.cos(t + Math.PI / 2)
                        )),
                ...
                (e.prototype.configPercentColors = function () {
                    ...
                    if (
                        ...
                        for (
                            ...
                            (a = parseInt(
                                c(this.options.percentColors[e][1]).substring(
                                    0,
                                    2
                                ),
                                16
                                ...
                                (i = parseInt(
                                    c(
                                        this.options.percentColors[e][1]
                                    ).substring(2, 4),
                                    16
                                )),
                                (t = parseInt(
                ...
                (e.prototype.set = function (t) {
                    ...
                    if (t.length > this.gp.length)
                        ...
                        t.length < this.gp.length &&
                            (this.gp = this.gp.slice(
                                this.gp.length - t.length
                            ));
                    ...
                    if (t !== {}) {
                        for (
                            ...
                            (this.ctx.lineWidth = this.lineWidth * h),
                                ...
                                (M =
                                    this.radius * this.options.radiusScale + f),
